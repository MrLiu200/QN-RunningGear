...
class UDPMulticastAPI : public QObject
{
    Q_OBJECT
public:
...
signals:
    ...
    void UDPAddLog(const QString &carNumber, const QString &WagonNumber, const QString &LogType, const QString &TriggerTime, const QString &LogContent);
    void UDPAddDimensional(QString Wagon, qint8 id, qint8 ch, uint32_t speed, QString time, QVector<float> Value);
    void UDPAddDemodulated(QString Wagon, qint8 id, qint8 ch, uint32_t speed, QString time, QVector<float> Value);
